...
public:
    ...
    // virtual void suspend(int sec=5) override { _uart.suspend(); }
    ...
    virtual bool is_command() override { return _uart.is_command(); }
    virtual void set_proceed_line(bool level) override { _uart.set_proceed_line(level); }
